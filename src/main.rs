...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let config_path1 = cfg_dir.to_owned().join("imp_40000_1_up.json");
    let config_path2 = cfg_dir.to_owned().join("imp_40000_2_up.json");

    tlc::cal_double(config_path1, config_path2)?;
